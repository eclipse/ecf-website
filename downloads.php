...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <b>ECF 3.13.6 Now Available (5/7/2017)</b>
    <p></p>
    <p>
    ECF 3.13.6 requires <b>Eclipse Mars, or Neon, or Apache Karaf 4 with Java 8</b>.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
...
<?php
	$html = ob_get_contents();
        ...
        $html = getNugget("EcfInstallViaKaraf3.13.6.html",$html);
        
        $html = getNugget("EcfInstallViaUpdate3.13.6.html",$html);
        
        $html = getNugget("EcfInstallViaZip3.13.6.html",$html);
