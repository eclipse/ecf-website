...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <b>ECF 3.14.16 Now Available (10/7/2020)</b>
    <p></p>
    <p>
    ECF 3.14.16 requires <b>Eclipse 2018-06 or newer, or Apache Karaf 4.2+ with Java 8+</b>.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
...
<?php
	$html = ob_get_contents();
        ...
        $html = getNugget("EcfInstallViaKaraf3.14.16.html",$html);
        
        $html = getNugget("EcfInstallViaUpdate3.14.16.html",$html);
        
        $html = getNugget("EcfInstallViaZip3.14.16.html",$html);
