...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <p><img border="0" src="../images/new.gif" width="31" height="14" alt="[new]"/>
     <b>Eclipse Communication Framework 1.0.0 build is now available.</b>
    <p></p>
    Note that ECF 1.0.0 requires <b>Eclipse 3.3M6</b> or newer.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
