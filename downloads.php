...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <b>ECF 3.14.34 Now Available (11//27022)</b>
    <p></p>
    <p>
    ECF 3.14.34 requires <b>Eclipse 2021-6 or newer, or Apache Karaf 4.3+ with Java 8+</b>.  Note that Eclipse since 2021-03 requires Java 11 or newer, but ECF still only requires Java 8.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
...
<?php
	$html = ob_get_contents();
        ...
        $html = getNugget("EcfInstallViaKaraf3.14.34.html",$html);
        
        $html = getNugget("EcfInstallViaUpdate3.14.34.html",$html);
        
        $html = getNugget("EcfInstallViaZip3.14.34.html",$html);
