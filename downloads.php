...
<div id="midcolumn">
 <div class="homeitem3col">
    <h3><?= $pageTitle ?></h3>
    <p>
    <b>ECF 3.15.1 Now Available (7/3/2024)</b>
    <p></p>
    <p>
    ECF 3.15.1 requires <b>Eclipse 2022-6 or newer, or Apache Karaf 4.4+ with Java 17+</b>.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
...
<?php
	$html = ob_get_contents();
        ...
        $html = getNugget("EcfInstallViaKaraf3.15.1.html",$html);
        
        $html = getNugget("EcfInstallViaUpdate3.15.1.html",$html);
        
        $html = getNugget("EcfInstallViaZip3.15.1.html",$html);
