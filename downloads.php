...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <b>ECF Mars/3.13.2 Now Available (4/25/2016)</b>
    <p></p>
    <p>
    ECF Mars/3.13.2 requires <b>Eclipse Luna, Mars, or Neon</b>.  See <a href="http://download.eclipse.org/eclipse/downloads/">here to get
...
<?php
	$html = ob_get_contents();
        ...
        $html = getNugget("EcfInstallViaKaraf3.13.2.html",$html);
        
        $html = getNugget("EcfInstallViaUpdate3.13.2.html",$html);
        
        $html = getNugget("EcfInstallViaZip3.13.2.html",$html);
