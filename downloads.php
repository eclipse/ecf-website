...
<div id="midcolumn">
 <div class="homeitem3col">
    ...
    <ul>
     ...
     version <b>before</b> installing 1.0.0.  To uninstall the previous version:
      ...
      <ul>
       ...
       <li>
       Now you may install 1.0.0 (via update site or zip).  See below for instructions.
       </li>
      </ul>
     </li>
     <li>Applications based upon 1.0.0 will not work with older servers (&gt;&#61; 0.9.2).  
     </li>
     <li>Applications created with ECF releases previous to 0.9.3 will not work with new servers.  
     The public ECF server at 
     <b>ecftcp://ecf.eclipse.org:3282/server has moved to 1.0.0. The ECF server no longer support old clients (0.9.2).</b>
     </li>
    </ul>

    <h4><b>Please see <a href="NewAndNoteworthy_1.0.0.html">New and Noteworthy for 1.0.0</a> for details about API changes</b></h4>
    <p></p>

    <h3>ECF Install via Update Site (preferred method)</h3>
     <p>
     For <a href="update_install.php">detailed instructions on using the Eclipse install/update mechanism to install ECF see here</a>.  
     See below for quick install.
     </p>
      <ul>
       <li>In Eclipse, choose <b>Help -> Software Updates -> Find and Install...</b>
       </li>
       <li>Choose <b>Search for New Features to Install -> Next</b>
       </li>
       <li>Choose <b>New Remote Site</b>
       </li>
      </ul>
      <ul>
       <li>Name: <b>ECF</b>
       </li>
       <li>URL: <b><a>http://download.eclipse.org/technology/ecf/update</a></b>
       <img border="0" src="images/new-update-site.jpg" width="373" height="170" alt="[new update]"/>
       </li>
       <li>Choose <b>both</b> the <b>ECF Core</b> and the <b>ECF Examples</b> features to install.
       </li>
      </ul>
     <p></p>
...
<ul>
<li>
     <b>The ECF SDK zip contains ECF core and example plugins, as well as source code for all plugins.</b><br/><br/>
       <table style="border-collapse: collapse;" border="0" cellpadding="" cellspacing="5">
         <tbody>
           ...
           <tr>
            <td>
             <a href="http://www.eclipse.org/downloads/download.php?file=/technology/ecf/org.eclipse.ecf.sdk-1.0.0.v20070215.S20070215.zip">
  	     org.eclipse.ecf.sdk-1.0.0.v20070215.S20070215.zip</a>&nbsp;
            </td>
            <td align="center">2007-02-15
            </td>
           </tr>
...
<ul>
<li>
         <b>This zip file contains ECF core plugins.</b><br/><br/>
            <table style="border-collapse: collapse;" border="0" cellpadding="" cellspacing="5">
            <tbody>
               <tr>
               <th bgcolor="#c0c0c0">File</th>
               ...
               <tr>
                <td>
                 <a href="http://www.eclipse.org/downloads/download.php?file=/technology/ecf/org.eclipse.ecf.core-1.0.0.v20070215.S20070215.zip">
                 org.eclipse.ecf.core-1.0.0.v20070215.S20070215.zip</a>&nbsp;
                </td>
...
<ul>
<li>
         <b>This zip file contains ECF examples plugins.</b><br/><br/>
            <table style="border-collapse: collapse;"  border="0" cellpadding="" cellspacing="5">
            <tbody>
               <tr>
               <th bgcolor="#c0c0c0">File</th>
	       ...
	       <tr>
                <td>
  	         <a href="http://www.eclipse.org/downloads/download.php?file=/technology/ecf/org.eclipse.ecf.examples-1.0.0.v20070215.S20070215.zip">
  	          org.eclipse.ecf.examples-1.0.0.v20070215.S20070215.zip</a>&nbsp;
                </td>
                <td align="center">2007-02-15</td>
               </tr>
              <tr>
         ...
         <ul>
            ...
            <li><b>Problems?</b> Check the <a href="faq.html">FAQ</a> and 
            <b><a href="https://bugs.eclipse.org/bugs/buglist.cgi?query_format=specific&amp;order=relevance+desc&amp;bug_status=__open__&amp;product=ECF&amp;content=">
            file a bug report</a></b>.
            </li>
         </ul>
         ...
         <p>
         <a href="http://ecf1.osuosl.org">ECF 'Extras' plugins are available via our site</a> 
         at the Oregon State University 
         <a href="http://www.osuosl.org">Open Source Lab</a>.
         </p>
         
         <h3>ECF Build Types</h3>
          <table border="0" cellspacing="5" cellpadding="2" width="100%" >
	    <tr>
             <td align="right" valign="top"><img src="../images/Adarrow.gif" border="0" height="16" width="16" alt="[Adarrow]"/></td>
             <td>
<font size="-1" face="arial,helvetica,geneva">
             ...
             <tr><td align="right" valign="top"><img src="../images/Adarrow.gif" border="0" height="16" width="16" alt="[Adarrow]"/></td>
             <td>
<font size="-1" face="arial,helvetica,geneva">
