...
?>		
	<div id="midcolumn">
		...
		<div class="homeitem3col">
            ...
            <h4>ECF committers and contributors often hang out on the #eclipse-ecf channel on irc.freenode.net.  See <a href="http://wiki.eclipse.org/Eclipse_Communication_Framework_Project#Public_and_Private_Chat_Groups">here</a> for more information.</h4>
		    <h3>Committers</h3>
			<ul>
				<li>
